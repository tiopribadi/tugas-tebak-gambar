...
public class TanggaActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_tangga);
    ...
    public void cekjawaban(View v){
    	String jawabanBenar = "TANGGAL MERAH";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tangga, menu);
		return true;
	}
