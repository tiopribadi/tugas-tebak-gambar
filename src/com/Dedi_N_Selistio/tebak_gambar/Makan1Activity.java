...
public class Makan1Activity extends Activity {
	EditText jawabanTxt;
	@Override
    ...
    public void cekjawaban(View v){
    	String jawabanBenar = "RUMAH MAKAN";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),TanggaActivity.class);
    		startActivity(i);
    	}
    	else{
    		//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.makan1, menu);
		return true;
	}
